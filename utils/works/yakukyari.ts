...
const work: Work = {
  ...
  overview: "???は日本で規模の大きい薬剤師専門転職サイトの一つです。主に自社含めた多くの薬剤師専門転職エージェント企業の求人を掲載しているのが最大の特徴です。",
  background: "私がXXXで携わっている中で最もビジネスインパクトの大きいアプリです。ここでは主により多くの薬剤師に訪問してもらう為の新機能開発や運用工数削減の為の改善施策を担当しています。その中でも規模の大きかった開発はレガシーjsの撤廃と新サービスの立ち上げです。前者はknockout.js -> vue.jsのリプレースをメインに、後者はDB設計や複数アプリと連携する為の機構作りを担当していました。",
  techStacks: [
    "HTML5",
    "CSS3",
    "Sass/Scss",
